    ...
    public class FingersRotateCameraComponentScript : MonoBehaviour
    {
        ...
        private void PanGestureUpdated(GestureRecognizer r)
        {
            ...
            if (r.State == GestureRecognizerState.Executing)
            {
                ...
                ApplyRotation(DeviceInfo.PixelsToUnits(r.DeltaX) * RotationSpeed, 0);
            }
            else if (r.State == GestureRecognizerState.Ended)
            {
                rotationVelocity = new Vector2(DeviceInfo.PixelsToUnits(r.VelocityX) * RotationSpeed * 0.01f, 0);
            }
        }
        ...
        private void OnEnable()
        {
            ...
            originalRotation = Quaternion.Euler(InitialRotation);
        }
